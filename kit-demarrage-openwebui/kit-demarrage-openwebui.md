...
Copier le dossier `kit-demarrage-openwebui` de `Z:\3.NUMERIQUE\PROJETS\2026_IA&BD_2026-HP-INT-001` sur son PC. Il contient le fichier `kit-demarrage-openwebui.pdf` (cette notice d'utilisation) et trois sous-dossiers :  
...
4. Dans Open WebUI, après avoir cliqué sur la bulle **Profil** en bas à gauche, **Réglages** → **Intégrations** → **Gérer les serveurs d'outils** → **➕ Ajouter une connexion**.
...
#### Lancement du MCP
Ces étapes devront être respectées à chaque utilisation du MCP de QGIS avec Open WebUI.
