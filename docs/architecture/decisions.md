...
**Extensibilité Open WebUI (pipelines/« functions » Python)** : Open WebUI permet d'étendre son comportement par du code Python custom (pipelines/functions), au-delà du MCP, ou en alternative.
...
Pas encore de catalogue et chantiers d'intégration en cours : le prototype ciblera des tables en particulier : 
- base éco
- MOS / Cosia
- logement social
